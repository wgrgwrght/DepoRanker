# -*- coding: utf-8 -*-
"""
Created on Sat Jan 15 08:56:40 2022

@author: George Wright
created for python version 3.9.7 xgboost version 1.5.0
"""
...
class XGBRanker(XGBModel):
    ...
    def __init__(self, max_depth=3, learning_rate=0.1, n_estimators=100,
                 verbosity=0, objective="rank:map", booster='gbtree',
        ...
        super(XGBRanker, self).__init__(max_depth, learning_rate,
                                        n_estimators, verbosity, objective, booster,
                                        tree_method, n_jobs, 
